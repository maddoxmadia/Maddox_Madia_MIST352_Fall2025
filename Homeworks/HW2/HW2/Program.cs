...
namespace HW2
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            double[] arrPrices = new double[] { 15.99, 23.50, 10.00, 9.75, 5.99, 14.25, 32.10, 18.40, 21.99, 7.50, 44.00, 28.75, 12.99, 19.25, 8.60, 5.75, 16.80, 33.33, 27.10, 22.45, 9.90, 11.20, 17.85, 29.60, 25.00, 14.95, 7.99, 39.99, 31.75, 13.50 };
